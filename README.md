...
The CLI is installed at `%LOCALAPPDATA%\OpenHardwareOS\cli-v0.1.6\ohm-cli.exe`.
...
[Release assets and checksums](https://github.com/SvenKunkka/OpenHardwareOS/releases/tag/v0.1.6)
